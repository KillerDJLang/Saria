...
// New trader settings sariashop
const baseJson = __importStar(require("../db/base.json"));
const Traders_1 = require("C:/snapshot/project/obj/models/enums/Traders");
const assortJson = __importStar(require("../db/assort.json"));
class SariaShop {
    constructor() {
        this.mod = "sariashop"; // Set name of mod so we can log it to console later
    }
    /**
    ...
    preAkiLoad(container) {
        ...
        Traders_1.Traders["SariaShop"] = "SariaShop";
    ...
    postDBLoad(container) {
        ...
        this.addTraderToLocales(tables, baseJson.name, "Saria", baseJson.nickname, baseJson.location, "A soldier with questionable motives, an unknown background, and a large supply of military goods. She's willing to trade, for a price of course.");
    ...
    registerProfileImage(preAkiModLoader, imageRouter) {
        ...
        imageRouter.addRoute(baseJson.avatar.replace(".jpg", ""), `${imageFilepath}/Saria.jpg`);
    }
    /**
